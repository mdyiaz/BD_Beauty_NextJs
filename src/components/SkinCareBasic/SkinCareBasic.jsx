    ...
    return (
        <div className='mt-10'>
            {/* <div className='bg-[pink] w-60 mx-auto  py-2  rounded-full '>
                <h1 className='text-center font-semibold'>SKIN CARE BASICS</h1>
            </div> */}

            <div className=' text-center bg-[#c00093]  lg:w-72 w-60 mx-auto py-2 rounded-lg'>
                <h1 className='text-center font-semibold  text-white  '>SKIN CARE BASICS</h1>
            </div>
